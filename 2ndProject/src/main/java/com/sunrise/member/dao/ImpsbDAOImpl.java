...
@Repository
public class ImpsbDAOImpl implements ImpsbDAO {
	...
	public int chk_Dday_history(MemberVO memberVO) throws Exception {
		int result = sqlSession.selectOne("custMapper.chk_Dday_history", memberVO);
		return result;
	}
	...
	public int chk_crd_exist(MemberVO memberVO) throws Exception {
		int result = sqlSession.selectOne("custMapper.chk_crd_exist", memberVO);
		return result;
	}
	...
	public int chk_crd_Noexist1(MemberVO memberVO) throws Exception {
		int result = sqlSession.selectOne("custMapper.chk_crd_Noexist1", memberVO);
		return result;
	}
	...
	public int chk_crd_Noexist(MemberVO memberVO) throws Exception {
		int result = sqlSession.selectOne("custMapper.chk_crd_Noexist", memberVO);
		return result;
	}
}
