...
public class CustDAOImpl implements CustDAO {
	...
	public String cust_no_seq() throws Exception{
		return sqlSession.selectOne("custMapper.cust_no_seq");
	}
	
	// 카드번호 NEXTVAL
	@Override
	public String crd_no_seq() throws Exception{
		return sqlSession.selectOne("memberMapper.crd_no_seq");
	}
	
	// 하나의 고객번호 공통 insert
	@Override
	public String comm_custNo(CustVO custVO) throws Exception{
		return sqlSession.selectOne("custMapper.comm_custNo", custVO);
	}
	
	// 고객TB REG_D = 신청TB RCV_D , 최초입회일자 = 접수일자 set 하기
	@Override
	public String set_init_D(MemberVO memberVO) throws Exception{
		return sqlSession.selectOne("custMapper.set_init_D", memberVO);
	}
	...
	public MemberVO get_BF_CRD_NO(MemberVO memberVO) throws Exception{
		return sqlSession.selectOne("custMapper.get_BF_CRD_NO", memberVO);
	}
	
	// 카드TB 업데이트 (최종카드여부)
	@Override
	public void upd_crd_renewal(MemberVO memberVO) throws Exception {
		sqlSession.selectList("custMapper.upd_crd_renewal", memberVO);
	}
		
	// 재발급 카드 정보 카드TB에 등록 (insert)
	@Override
	public void insert_crd_renewal(MemberVO memberVO) throws Exception {
		sqlSession.insert("custMapper.insert_crd_renewal", memberVO);
	}
